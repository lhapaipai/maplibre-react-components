import { CustomRenderMethod, Map, MercatorCoordinate } from "maplibre-gl";
import "./App.css";
...
function onAdd(_map: Map, gl: WebGLRenderingContext | WebGL2RenderingContext) {
  ...
  const helsinki = MercatorCoordinate.fromLngLat({ lng: 25.004, lat: 60.239 });
...
const render: CustomRenderMethod = (gl, args) => {
