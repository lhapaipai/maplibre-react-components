...
function ChildComponent() {
  ...
  // your mapManager instance is always available
...
<Flash color="yellow">
If you use `useMapManager` inside `<RMap />` and you're using TypeScript it is better not to specify an `id` because 
...
<Flash color="orange">
This might seem useless if your application contains only one map instance but this precaution allows TypeScript to return the correct type.
</Flash>
...
function ChildComponent() {
  // This component contain <RMap /> or <RMap /> is a child of this component
  // your MapLibre map instance is not always available
  // you need to provide your <RMap /> id
